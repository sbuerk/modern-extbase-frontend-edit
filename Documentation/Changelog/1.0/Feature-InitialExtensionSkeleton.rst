...
Initial skeleton of the ``sbuerk/modern-extbase-frontend-edit`` extension, providing the
...
The extension ships a :php:`SBUERK\ModernExtbaseFrontendEdit\Dummy` placeholder class
and an :php:`SBUERK\ModernExtbaseFrontendEdit\Example\ExampleInterface` example
