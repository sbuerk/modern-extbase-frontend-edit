...
namespace SBUERK\ModernExtbaseFrontendEdit\Tests\Functional\Core13\Example;

use PHPUnit\Framework\Attributes\Group;
use PHPUnit\Framework\Attributes\Test;
use SBUERK\ModernExtbaseFrontendEdit\Core13\Example\Example;
...
final class ExampleTest extends AbstractFunctionalTestCase
{
    ...
    {
        $otherImplementation = 'SBUERK\\ModernExtbaseFrontendEdit\\Core14\\Example\\Example';
